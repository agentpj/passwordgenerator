...
var charsLowerCase = ["a","b","c","d","e","f","g"];
var charsUpperCase = ["ABCDEFG"];
...
if (wantUpperCase) {
  ...
  var newString = newString.toUpperCase(alphabet);
  console.log(newString); {
  if (tempCharSelection.length > 0) {
  tempCharSelection = tempCharSelection.concat(newString);}
  else {
    console.log("else WantUpper " + charSelection);
    tempCharSelection=newString;
    // tempCharSelection = tempCharSelection.concat(charSelection);
       }
